...
if aba_selecionada == "Gerenciamento de Tarefas":
    ...
    if eventos_futuros:
        ...
        with st.expander(f"Ver compromissos no período ({len(df_futuro)} encontrados)", expanded=True):
            ...
            # Tabela limpa e alinhada com coluna extra pequena à direita para o checkbox antigo
            ...
            # Mini cards de Excluir e Editar sem emojis e sem títulos intermediários
