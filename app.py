...
if aba_selecionada == "Gerenciamento de Tarefas":
    ...
    if eventos_futuros:
        ...
        with st.expander(f"Ver compromissos no período ({len(df_futuro)} encontrados)", expanded=True):
            ...
            # Estrutura limpa idêntica à original, adicionando apenas a coluna de seleção pequena à direita
            ...
            # Mini cards de Excluir e Editar logo abaixo
